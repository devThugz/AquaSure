...
import { FishIcon, KeyIcon, MailIcon, UserIcon, ArrowLeftIcon, MapPinIcon } from 'lucide-react';
export function Signup() {
  ...
  const regions = ['Ilocos Region', 'Cagayan Valley', 'Central Luzon', 'CALABARZON', 'MIMAROPA', 'Bicol Region', 'Western Visayas', 'Central Visayas', 'Eastern Visayas', 'Zamboanga Peninsula', 'Northern Mindanao', 'Davao Region', 'SOCCSKSARGEN', 'Caraga', 'Bangsamoro', 'Cordillera Administrative Region', 'National Capital Region'];
      ...
      <div className="w-full max-w-md mx-auto relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-sm sm:text-base text-teal-50 max-w-sm mx-auto px-4 font-medium">
            Create your account to access smart insurance and fishing management
          </p>
        </div>
        {/* Signup Form Card */}
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input id="name" name="name" type="text" required value={name} onChange={e => setName(e.target.value)} className="appearance-none block w-full pl-11 pr-4 py-3.5 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm sm:text-base transition-all duration-200" placeholder="Enter your full name" />
                </div>
              </div>
              {/* Email Input */}
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  For admin access use: admin@aquasure.com, for super admin use:
                  superadmin@aquasure.com
                </p>
              </div>
              {/* Region Select */}
              <div>
                <label htmlFor="region" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                  Region
                </label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <MapPinIcon className="h-5 w-5 text-gray-400 group-focus-within:text-teal-500 transition-colors" />
                  </div>
                  <select id="region" name="region" required value={region} onChange={e => setRegion(e.target.value)} className="appearance-none block w-full pl-11 pr-4 py-3.5 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm sm:text-base transition-all duration-200">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input id="password" name="password" type="password" autoComplete="new-password" required value={password} onChange={e => setPassword(e.target.value)} className="appearance-none block w-full pl-11 pr-4 py-3.5 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm sm:text-base transition-all duration-200" placeholder="••••••••" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input id="confirmPassword" name="confirmPassword" type="password" autoComplete="new-password" required value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} className="appearance-none block w-full pl-11 pr-4 py-3.5 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm sm:text-base transition-all duration-200" placeholder="••••••••" />
                </div>
              </div>
              {/* Error Message */}
